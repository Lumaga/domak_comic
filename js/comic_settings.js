...
const pgData = [
    {
        ...
        date: writeDate(2025, 4, 25), //the date on which the page was posted (mainly for the archive). The date is written using a function called "writeDate", basically just put writeDate and then some parenthesis and, comma separated, the year followed by the month and the day. Don't forget another comma at the end outside the parenthesis!
        ...
        authorNotes: `
            <p>Hello!</p>
            <p>I'm gonna try to make this font larger...</p>
            `,
    },
    {
        pgNum: 2,
        title: "",
        date: writeDate(2025, 4, 25),
        altText: "Here's some more alt text!",
        imageFiles: 1,
        authorNotes: `
            <p>Diferent author notes for every page yay.</p>
            <p>Filler text, but I'm too sleepy to open a new tab and search for Lorem Ipsum. I need a larger text just to see how it looks when it goes to a diferent line. I'll try creating links and stuff later, I have to make everything manually, but at least I can ctrl+z my errors.</p>
            `,
    },
    {
        pgNum: 3,
        ...
        imageFiles: 1,
        authorNotes: `
            <p>I don't know what to write again. Let's try <b>bold font</b></p>
			<p>Let's try dropping a link: <a href="https://lumaga.carrd.co/" target="_blank">Click here</a>. Woah, it even opens on another tab! *absolute html css noob*</p>
            `,
    },
